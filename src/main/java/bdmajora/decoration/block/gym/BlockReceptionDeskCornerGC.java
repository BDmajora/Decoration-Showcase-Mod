...
public class BlockReceptionDeskCornerGC extends BlockTransparent {
	public useless.dragonfly.model.block.processed.BlockModel model;

	public BlockReceptionDeskCornerGC(String key, int id, Material material, BlockModel model) {
